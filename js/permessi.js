...
// Formato: "COGNOME": { GiornoSettimana: TurnoDestinazione "SCHIRRU": { 1: 2, 3: 2, 4: 2 }, // Turno 2 Lun, Mer, Gio }
...
// 2. PERMESSI PERMANENTI (Dettaglio Orari)
    const ORARI_PP = { 
        // Configurazione orari PP predefiniti (Giorno: 1=Lun, 2=Mar, 3=Mer, 4=Gio)  "BERRUTI A": { 4: { out: "13:30", in: "NO rientro" }}
...
// 3. ASSENTI PERMESSO DINNER (Chi non cena per giorno) 1: ['TESSARIN']
